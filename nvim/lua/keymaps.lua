...
vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { desc = "open quickfix window" })
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = "open float window" })
